...
class KinsDataset(CocoDataset):

    CLASSES = ('cyclist', 'pedestrian', 'rider', 'car', 'tram', 'truck', 'van', 'misc')

    def prepare_train_img(self, idx):
        img_info = self.data_infos[idx]
        ann_info = self.get_ann_info(idx)
        depth_info = dict(filename=img_info['filename'])
    ...
    def evaluate(self,
        ...
        """
        if metric[0] == 'bbox':
            return super(KinsDataset, self).evaluate(results,metric='bbox',classwise=classwise)
